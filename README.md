...
3. 导入 [`发布/蔷薇前端-BaraFrontend-1.0-RosaCaninae.json`](发布/)
...
打包产物在 `dist/BaraFrontend/蔷薇前端-单文件脚本.json`。版本号的唯一来源是 `src/BaraFrontend/domain/plugin-license.ts` 的 `PLUGIN_VERSION`，打包脚本从那里读，不要另写一份。
