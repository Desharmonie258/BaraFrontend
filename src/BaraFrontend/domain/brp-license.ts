/**
 * BRP Open Game License, Version 1.0 的完整文本与法定版权声明。
 *
 * 为什么必须整段内嵌而不是给个链接：
 *
 * - **§3** 要求 "You must affix a complete copy of this License to any BRP
 *   Open Game Content that You Use"。affix（附上）指的是随作品分发，
 *   外链不构成 affix —— 链接会失效，而许可证要求副本随作品存在。
 * - **§7** 的版权声明有逐字指定的原文，必须照抄。
 * - **§15** 授权展示 BRP 标识，但**仅限用于标注 Use of the Open Content**
 *   这一目的。也就是说：要么完整合规、要么不能用那个标识。
 *
 * 因此本文件是纯法务文本，恒为英文、不参与 i18n、不可由用户关闭。
 *
 * 文本转录自 Basic Roleplaying System Reference Document 1.0.2 第 1–2 页。
 */

/** §7 规定的版权声明。逐字原文，改动即违约。 */
export const BRP_COPYRIGHT_NOTICE = [
  'This work created using the BRP Open Game License.',
  'BRP Open Game License v 1.0 © copyright 2020 Chaosium Inc.',
  'Basic Roleplaying © copyright 1980–2020 Chaosium Inc.; Authors, original rules: ' +
    'Greg Stafford, Steve Henderson, Warren James, Steve Perrin, Sandy Petersen, ' +
    'Ray Turney, and Lynn Willis; developed by Jason Durall, James Lowder, and Jeff Richard.',
  'Basic Roleplaying and the BRP logo are trademarks of Chaosium Inc. Used with permission.',
] as const;

/**
 * §9 要求指明作品的哪些部分是 Open Game Content。
 * 这一段是本插件自己的声明，不是许可证原文。
 */
export const BRP_OGC_DECLARATION =
  'Open Game Content: the percentile resolution mechanics of the BRP rule family ' +
  '(skill rolls, difficulty multipliers, levels of success, and the resistance table ' +
  'concept) as implemented in this plugin. All other content — the user interface, ' +
  'the database schema, all character data, and the d20 and Storyteller rule ' +
  'families — is not Open Game Content.';

/** BRP Open Game License, Version 1.0 全文（§3 要求附上完整副本）。 */
export const BRP_LICENSE_TEXT = `BRP Open Game License, Version 1.0
...
(f) "Trademark" means the logos, names, marks, signs, mottos, and designs that are used by a Contributor to identify itself or its products or the associated products contributed to the BRP Open Game License by the Contributor;

(g) "Use," "Used," or "Using" means to use, distribute, copy, edit, format, modify, translate, and otherwise create Derivative Material of Open Game Content;

(h) "You" or "Your" means the licensee in terms of this agreement.

2. Grant: Except for material designated as Prohibited Content (see Section 1(e) above), the Basic Roleplaying System Reference Document is Open Game Content, as defined in the BRP Open Game License version 1.0, Section 1(d). No portion of this work other than the material designated as Open Game Content may be reproduced in any form without permission from Chaosium.
...
4. Offer and Acceptance: By Using the BRP Open Game Content You indicate Your acceptance of the terms of the BRP Open Game License.
...
7. Copyright Notice: You must update the Copyright Notice portion of this License to include the current version of the text of the Copyright Notice of any BRP Open Game Content You are copying, modifying, or distributing.

This work created using the BRP Open Game License.

BRP Open Game License v 1.0 © copyright 2020 Chaosium Inc.

Basic Roleplaying © copyright 1980–2020 Chaosium Inc.; Authors, original rules: Greg Stafford, Steve Henderson, Warren James, Steve Perrin, Sandy Petersen, Ray Turney, and Lynn Willis; developed by Jason Durall, James Lowder, and Jeff Richard.
...
[The BRP logo is displayed above, on the rule family selector.]
